...
<div id="lContainer">
  <form class="lform" onSubmit={handleSubmit}>
    ...
    <input class="form-content" type="text" placeholder="UserName" value={values.name} name="name" onChange={handleChange}/>
    <input class="form-content" type="password" placeholder="PassWord" value={values.password} onChange={handleChange}/>
